					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								<li class="current"><a href="menuPITRegistrarNoticia.php">Registrar Noticias</a></li>
   							...
   							<div class="w3-row-padding">
								...
								<div class="form-group">
									...
									<form action="../Controlador/registrar.php" method="POST" enctype="multipart/form-data">
												...
												<br><label class="w3-label">TITULO DE NOTICIA</label>
												<input type="text" name="nombres" class="form-control" placeholder="Nombre de la noticia">
